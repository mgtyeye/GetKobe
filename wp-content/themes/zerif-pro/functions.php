...
function zerif_php_style() {
	...
	echo ' .navbar, .navbar-inverse .navbar-nav ul.sub-menu { background: '.get_theme_mod('zerif_navbar_color').'; }';
	echo '	.entry-title, .entry-title a, .widget-title, .widget-title a, .page-header .page-title, .comments-title, h1.page-title { color: '. get_theme_mod('zerif_titles_color') .' !important}';
	echo '	.widget .widget-title:before, .entry-title:before, .page-header .page-title:before, .entry-title:after, ul.nav > li.current_page_item > a:before, .nav > li.current-menu-item a:before, h1.page-title:before { background: '. get_theme_mod('zerif_titles_bottomborder_color') .' !important; }';
	echo '	body, button, input, select, textarea { color: '. get_theme_mod('zerif_texts_color') .' }';
	echo '	.widget li a, article .entry-meta a, .entry-footer a, .navbar-inverse .navbar-nav>li>a, .navbar-inverse .navbar-nav ul.sub-menu li a, .home .nav > li.current_page_item a { color: '. get_theme_mod('zerif_links_color') .' !important; }';
	...
	echo '	.big-title-container .intro-text { color: '. get_theme_mod('zerif_bigtitle_header_color') .'}';
	echo '	.big-title-container .red-btn { background: '. get_theme_mod('zerif_bigtitle_1button_background_color') .'}';
	echo '	.big-title-container .red-btn:hover { background: '. get_theme_mod('zerif_bigtitle_1button_background_color_hover') .'}';
	echo '	.big-title-container .buttons .red-btn { color: '. get_theme_mod('zerif_bigtitle_1button_color') .' !important }';
	echo '	.big-title-container .green-btn { background: '. get_theme_mod('zerif_bigtitle_2button_background_color') .'}';
	echo '	.big-title-container .green-btn:hover { background: '. get_theme_mod('zerif_bigtitle_2button_background_color_hover') .'}';
	...
	echo '	.about-us .our-clients .section-footer-title { background: '. get_theme_mod('zerif_aboutus_background') .' }';
	...
	echo '	.our-team .team-member:hover .details { color: '. get_theme_mod('zerif_ourteam_text') .' }';
	echo '	.our-team .team-member .social-icons ul li a:hover { color: '. get_theme_mod('zerif_ourteam_socials_hover') .' }';
	echo '	.our-team .team-member .social-icons ul li a { color: '. get_theme_mod('zerif_ourteam_socials') .' }';
	...
	echo '	.separator-one h3 { color: '. get_theme_mod('zerif_ribbon_text_color') .' !important; }';
	...
	echo '	.purchase-now h3 { color: '. get_theme_mod('zerif_ribbonright_text_color') .' }';
	...
	echo '	.contact-us button { background: '. get_theme_mod('zerif_contacus_button_background') .' }';
	echo '	.contact-us button:hover { background: '. get_theme_mod('zerif_contacus_button_background_hover') .' !important; box-shadow: none; }';
	echo '	.contact-us button, .pirate_forms .pirate-forms-submit-button { color: '. get_theme_mod('zerif_contacus_button_color') .' !important; }';
	...
	if ( !empty($zerif_latestnews_post_title_color) ){
		echo '	#latestnews #carousel-homepage-latestnews .carousel-inner .item .latestnews-title a { color: '. get_theme_mod('zerif_latestnews_post_title_color','#404040') .'}';
	}
	...
	if ( !empty($zerif_latestnews_post_underline_color1) ){
		echo '	#latestnews #carousel-homepage-latestnews .item .latestnews-box:nth-child(4n+1) .latestnews-title a:before { background: '. get_theme_mod('zerif_latestnews_post_underline_color1','#e96656') .'}';
	}
	...
	if ( !empty($zerif_latestnews_post_underline_color2) ){
		echo '	#latestnews #carousel-homepage-latestnews .item .latestnews-box:nth-child(4n+2) .latestnews-title a:before { background: '. get_theme_mod('zerif_latestnews_post_underline_color2','#34d293') .'}';
	}
	...
	if ( !empty($zerif_latestnews_post_underline_color3) ){
		echo '	#latestnews #carousel-homepage-latestnews .item .latestnews-box:nth-child(4n+3) .latestnews-title a:before { background: '. get_theme_mod('zerif_latestnews_post_underline_color3','#3ab0e2') .'}';
	}
	...
	if ( !empty($zerif_latestnews_post_underline_color4) ){
		echo '	#latestnews #carousel-homepage-latestnews .item .latestnews-box:nth-child(4n+4) .latestnews-title a:before { background: '. get_theme_mod('zerif_latestnews_post_underline_color4','#f7d861') .'}';
	}
	
	$zerif_latestnews_post_text_color = get_theme_mod('zerif_latestnews_post_text_color');
	if ( !empty($zerif_latestnews_post_text_color) ){
		echo '	#latestnews .latesnews-content p, .latesnews-content { color: '. get_theme_mod('zerif_latestnews_post_text_color','#909090') .'}';
	}
	...
	echo ' section#subscribe h3, .newsletter .sub-heading, .newsletter label { color: '.get_theme_mod('zerif_subscribe_header_color').' !important; }';
	echo ' section#subscribe input[type="submit"] { color: '.get_theme_mod('zerif_subscribe_button_color').' !Important; }';
	echo ' section#subscribe input[type="submit"] { background: '.get_theme_mod('zerif_subscribe_button_background_color').' !important; }';
	echo ' section#subscribe input[type="submit"]:hover { background: '.get_theme_mod('zerif_subscribe_button_background_color_hover').' !important; }';
	...
	echo '	#footer .company-details, #footer .company-details a { color: '. get_theme_mod('zerif_footer_text_color') .' }';
	...
	echo '	.comment-form #submit, .comment-reply-link,.woocommerce .add_to_cart_button, .woocommerce .checkout-button, .woocommerce .single_add_to_cart_button, .woocommerce #place_order, .edd-submit.button, .page button, .post button, .woocommerce-page .woocommerce input[type="submit"], .woocommerce-page #content input.button, .woocommerce input.button.alt, .woocommerce-page #content input.button.alt, .woocommerce-page input.button.alt { background: '. get_theme_mod('zerif_buttons_background_color') .' !important; }';
	
	echo '	.comment-form #submit:hover, .comment-reply-link:hover, .woocommerce .add_to_cart_button:hover, .woocommerce .checkout-button:hover, .woocommerce  .single_add_to_cart_button:hover, .woocommerce #place_order:hover, .edd-submit.button:hover, .page button:hover, .post button:hover, .woocommerce-page .woocommerce input[type="submit"]:hover, .woocommerce-page #content input.button:hover, .woocommerce input.button.alt:hover, .woocommerce-page #content input.button.alt:hover, .woocommerce-page input.button.alt:hover { background: '. get_theme_mod('zerif_buttons_background_color_hover') .' !important; box-shadow: none; }';
	
	echo '	.comment-form #submit, .comment-reply-link, .woocommerce .add_to_cart_button, .woocommerce .checkout-button, .woocommerce .single_add_to_cart_button, .woocommerce #place_order, .edd-submit.button span, .page button, .post button, .woocommerce-page .woocommerce input[type="submit"], .woocommerce-page #content input.button, .woocommerce input.button.alt, .woocommerce-page #content input.button.alt, .woocommerce-page input.button.alt { color: '. get_theme_mod('zerif_buttons_text_color') .' !important }';
